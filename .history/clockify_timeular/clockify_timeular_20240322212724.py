...
async def callback_with_state(
    ...
    with state_lock:
        ...
        try:
            ...
            await asyncio.sleep(60) #wait for 1 minute before logging time entry
            if state != prev_state:
                return    
...
def start_time_entry(state: State, start_time: str=now(), description: str, project_id: str, task_id: str = None):
